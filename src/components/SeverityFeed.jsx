  ...
  return (
    <div className="card col-span-2">
      <div className="card-title">
        ...
        Active Incidents
        {criticalCount > 0 && (
          <span className="badge badge-critical" style={{ marginLeft: "auto" }}>{criticalCount} critical</span>
        )}
        {criticalCount === 0 && incidents.length > 0 && (
          <span className="badge badge-low" style={{ marginLeft: "auto" }}>No critical</span>
        )}
      </div>
