...
export default function PrimaryThreat({ incidents, ipScores, onInvestigate }) {
  // Find the highest-scored IP with at least one CRITICAL incident
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: "14px", flex: 1 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: "12px", flexWrap: "wrap", marginBottom: "8px" }}>
              <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: "22px", color: "var(--red)", letterSpacing: "0.05em" }}>
                {ip}
              </span>
            </div>
